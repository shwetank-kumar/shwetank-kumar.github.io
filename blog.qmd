...
# before-body: subscribe.html
---

<style type="text/css">@import url("https://assets.mlcdn.com/fonts.css?version=1728988");</style>
    <style type="text/css">
    /* LOADER */
  ...
  <script>
    function ml_webform_success_18937141() {
      var $ = ml_jQuery || jQuery;
      $('.ml-subscribe-form-18937141 .row-success').show();
      $('.ml-subscribe-form-18937141 .row-form').hide();
    }
      </script>
